...
(function (global, factory) {
  ...
  */
  ...
  OptionSelect.prototype.init = function () {
    ...
    }.bind(this)); // Watch Expander button to adjust height if necessary
  ...
  OptionSelect.prototype.attachCheckedCounter = function attachCheckedCounter(checkedString) {
    this.$optionSelect.querySelector('.js-toggle, .js-button').insertAdjacentHTML('afterend', '<div class="dm-option-select__selected-counter js-selected-counter">' + checkedString + '</div>');
  };
