...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define('DMGOVUKFrontend', ['exports'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.DMGOVUKFrontend = {}));
  ...
  */
  ...
  OptionSelect.prototype.init = function () {
    ...
    }.bind(this)); // Replace div.container-head with a button

    this.replaceHeadingSpanWithButton(); // Add js-collapsible class to parent for CSS

    this.$optionSelect.classList.add('js-collapsible'); // Add open/close listeners
  ...
  OptionSelect.prototype.replaceHeadingSpanWithButton = function replaceHeadingSpanWithButton() {
    ...
    */
    ...
    var jsContainerHeadHTML = $containerHead.innerHTML; // Create button and replace the preexisting html with the button.

    var $button = document.createElement('button');
    $button.classList.add('js-container-button', 'dm-option-select__title', 'dm-option-select__button'); // Add type button to override default type submit when this component is used within a form
  ...
  OptionSelect.prototype.attachCheckedCounter = function attachCheckedCounter(checkedString) {
    this.$optionSelect.querySelector('.js-container-button').insertAdjacentHTML('afterend', '<div class="dm-option-select__selected-counter js-selected-counter">' + checkedString + '</div>');
  };
  ...
  OptionSelect.prototype.getVisibleCheckboxes = function getVisibleCheckboxes() {
    var visibleCheckboxes = [].slice.call(this.$options).filter(this.isCheckboxVisible.bind(this)); // add an extra checkbox, if the label of the first is too long it collapses onto itself
  ...
  OptionSelect.prototype.setupHeight = function setupHeight() {
    var initialOptionContainerHeight = this.$optionsContainer.clientHeight;
    var height = this.$optionList.offsetHeight; // check whether this is hidden by progressive disclosure,
